...
parser.add_argument("-b", "--bin_size", type=int, help="Size of the bins of documents", default=1)
parser.add_argument("-n", "--max_n_bins", type=int, help="Maximum number of bins", default=3)
