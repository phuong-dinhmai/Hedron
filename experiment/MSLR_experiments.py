...
def experiment(file_path):
    ...
    for qid in x:
        ...
        # s2_objs = [evaluation(point, rel, item_group_masking, group_fairness, None) for point in s_2_points]
        # draw([qp_objs, s2_objs], ["baseline", "Sphere-Expo_5"])
